...
namespace QuickDate.SQLite
{
    public class SqLiteDatabase : IDisposable
    {
        ...
        public static readonly string PathCombine = Path.Combine(Folder, "QuickDate.db");
                ...
                using (Connection = OpenConnection())
                {
                    ...
                    if (select != null)
                    {
                        ...
                        if (db != null)
                        {
                            ...
                            ListUtils.SettingsSiteList = new ObservableCollection<GetOptionsObject.DataOptions> { db };
