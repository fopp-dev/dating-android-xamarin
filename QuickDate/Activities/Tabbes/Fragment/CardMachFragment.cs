...
namespace QuickDate.Activities.Tabbes.Fragment
{
    public class CardMachFragment : Android.Support.V4.App.Fragment, CardStackView.ICardEventListener, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private string TotalIdLiked = "", TotalIdDisLiked = "", IdGender = GlobalConstants.FilterOptionGenderMale;
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SwipeCount = Preferences.GetSwipeCountValue();
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            try
            {
                View = inflater.Inflate(Resource.Layout.TCardMachLayout, container, false);
                return View;
            }
            catch (Exception e)
            {
        ...
        {
            Preferences.StoreSwipeCountValue(SwipeCount);
        }
        ...
        private void OpenDialog()
        {
            try
            {
                var showTutorialDialog = Preferences.GetShowTutorialDialogValue();
        ...
        private class ApiPostUpdaterHelper : Java.Lang.Object, IRunnable
        {
            ...
            public void Run()
            {
                try
                {
                    ...
                    MainHandler?.PostDelayed(new ApiPostUpdaterHelper(Activity, new Handler()), 20000);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
            ...
            try
            {
                ...
                if (itemString.ToString() == GetString(Resource.String.Lbl_Default))
                {
                    ...
                    if (enumerable != null)
                    {
                        ...
                        IdGender = !string.IsNullOrEmpty(IdGender) ? IdGender.Remove(IdGender.Length - 1, 1) : GlobalConstants.FilterOptionGenderMale;
                    }
                }
                else
                {
                    IdGender = genderArray ?? GlobalConstants.FilterOptionGenderMale;
                }
