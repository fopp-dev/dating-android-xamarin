...
namespace QuickDate.Activities.Tabbes.Adapters
{
    ...
    {
        public event EventHandler<TrendingAdapterClickEventArgs> TrendingItemClick;
        public event EventHandler<TrendingAdapterClickEventArgs> TrendingItemLongClick;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                if (viewType == (int)ItemType.ProUser || viewType == (int)ItemType.HotOrNot)
                {
                    ...
                    var vh = new TrendingAdapterViewHolder(itemView, TrendingOnClick, TrendingOnLongClick);
                    return vh;
                }

                if (viewType == (int)ItemType.Users)
                {
                    //Setup your layout here >> TemplateRecyclerViewLayout
        ...
        public override int GetItemViewType(int position)
        {
            try
            {
                ...
                {
                    if (item.Type == ItemType.ProUser)
                        return (int)ItemType.ProUser;

                    if (item.Type == ItemType.HotOrNot)
                        return (int)ItemType.HotOrNot;
                    
                    if (item.Type == ItemType.Users)
                        return (int)ItemType.Users;
        ...
        void TrendingOnClick(TrendingAdapterClickEventArgs args) => TrendingItemClick?.Invoke(ActivityContext, args);
        void TrendingOnLongClick(TrendingAdapterClickEventArgs args) => TrendingItemLongClick?.Invoke(ActivityContext, args);
    }
