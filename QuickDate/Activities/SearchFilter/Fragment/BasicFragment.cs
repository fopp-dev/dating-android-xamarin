...
{
    public class BasicFragment : Android.Support.V4.App.Fragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, SeekBar.IOnSeekBarChangeListener
    {
        ...
        public int AgeMin = GlobalConstants.FilterOptionAgeMin, AgeMax = GlobalConstants.FilterOptionAgeMax;
        public string Gender = GlobalConstants.FilterOptionGender, Location = "";
