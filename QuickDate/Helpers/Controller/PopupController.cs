            ...
            try
            {
                ...
                if (position > -1)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        if (AppSettings.PaymentsSystem == PaymentsSystem.All)
                        {
                        ...
                        else if (AppSettings.PaymentsSystem == PaymentsSystem.JustInAppBillingGoogle && AppSettings.ShowInAppBilling && Client.IsExtended)
                        {
